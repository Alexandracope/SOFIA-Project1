...
from application.forms import CollectionForm, RegistrationForm, LoginForm, UpdateAccountForm
...
def collection():
	...
	if form.validate_on_submit():
		...
		print(form.errors)
	return render_template('collection.html', title='Docs', form=form)
